...
public class Interceptor extends HandlerInterceptorAdapter
{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception
	{
		 ...
		 */
		if (!request.getRequestURI().equals("/") && !request.getRequestURI().equals("/login.do") && !request.getRequestURI().equals("/autoLogin.do")
			...
			&& !request.getRequestURI().equals("/main.logIn.AutoLoginUserList.do"))
		{
